...
public class TwoSortedArrayMedian {
    ...
    * Sample Data that will lead to the first if condition:
    *   A = [1]
    *   B = [2, 3] 
    *
    * Sample Data that will lead to the second if condition:
    *   A = [2, 3]
    *   B = [1]
    *
    * Sample Data that will lead to the third if condition:
    *   A = [3]
    *   B = [1, 2]
    *
    *   or
